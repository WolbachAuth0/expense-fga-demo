        ...
        <tr>
          <td>
            <v-chip color="success"
              >${{ parseFloat(item.amount).toFixed(2) }}</v-chip
            >
          </td>
          <td>{{ item.merchant }}</td>
          ...
          <td>
            <v-btn
              v-if="!item.isApproved && !item.isRejected"
              variant="outlined"
              color="secondary"
              size="small"
              class="mx-2"
